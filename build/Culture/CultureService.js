...
define("Culture/CultureService", ["require", "exports", "durandal/binder", "Culture/CultureDetectionMethod", "Globalization/CultureInfo", "i18next", "jquery"], function (require, exports, binder, CultureDetectionMethod, CultureInfo, i18next, jquery) {
    "use strict";
    // #endregion
    /**
    ...
    var CultureService = (function () {
        ...
        CultureService.use = function (configuration) {
            ...
            binder.binding = function (viewModel, view) { return jquery(view).find("[data-localization]").each(function (index, element) { return jquery(element).text(i18next.t(jquery(element).data("localization"))); }); };
